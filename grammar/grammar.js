...
var grammar = {
    ...
    {"name": "kw_collection", "symbols": [(lexer.has("collection") ? {type: "collection"} : collection)]},
    ...
    {"name": "collection_name", "symbols": ["word"], "postprocess": d => d[0]},
    ...
    {"name": "select_statement", "symbols": ["kw_select", (lexer.has("ws") ? {type: "ws"} : ws), "select_what", (lexer.has("ws") ? {type: "ws"} : ws), "kw_from", (lexer.has("ws") ? {type: "ws"} : ws), "collection_name"], "postprocess":  d => {
            return{
                "type":"select",
                "params":{
                    "columns" : d[2],
    ...
    {"name": "select_statement", "symbols": ["kw_select", (lexer.has("ws") ? {type: "ws"} : ws), "select_what", (lexer.has("ws") ? {type: "ws"} : ws), "kw_from", (lexer.has("ws") ? {type: "ws"} : ws), "collection_name", (lexer.has("ws") ? {type: "ws"} : ws), "where_statement"], "postprocess":  d => {
            return{
                "type":"select",
                "params":{
                    "columns" : d[2],
    ...
    {"name": "create_collection_statement", "symbols": ["kw_create", (lexer.has("ws") ? {type: "ws"} : ws), "kw_collection", (lexer.has("ws") ? {type: "ws"} : ws), "collection_name", (lexer.has("ws") ? {type: "ws"} : ws), "column_name_array"], "postprocess":  d => {
            return{
    ...
    {"name": "create_index_statement", "symbols": ["kw_create", (lexer.has("ws") ? {type: "ws"} : ws), "kw_index", (lexer.has("ws") ? {type: "ws"} : ws), "index_name", (lexer.has("ws") ? {type: "ws"} : ws), "kw_on", (lexer.has("ws") ? {type: "ws"} : ws), "collection_name", (lexer.has("ws") ? {type: "ws"} : ws), "column_name_array"], "postprocess":  d => {
            return{
                "type":"create index",
                "params":{
                    "collection" : d[8],
    ...
    {"name": "insert_statement", "symbols": ["kw_insert", (lexer.has("ws") ? {type: "ws"} : ws), "collection_name", (lexer.has("ws") ? {type: "ws"} : ws), "insert_collection_columns"], "postprocess":  d => {
            return{
                "type":"insert",
                "params":{
                    "document" : d[4],
    ...
    {"name": "bulk_insert_statement", "symbols": ["kw_bulk", (lexer.has("ws") ? {type: "ws"} : ws), "kw_insert", (lexer.has("ws") ? {type: "ws"} : ws), "collection_name", (lexer.has("ws") ? {type: "ws"} : ws), "column_object_array"], "postprocess":  d => {
            return{
                "type":"bulk insert",
                "params":{
                    "documents" : d[6],
    ...
    {"name": "insert_collection_columns", "symbols": ["column_name_array"], "postprocess": d => d[0]},
    {"name": "insert_collection_columns", "symbols": ["column_object"], "postprocess": d=> d[0]},
    ...
    {"name": "update_statement", "symbols": ["kw_update", (lexer.has("ws") ? {type: "ws"} : ws), "collection_name", (lexer.has("ws") ? {type: "ws"} : ws), "set", (lexer.has("ws") ? {type: "ws"} : ws), "set_key_value_array", (lexer.has("ws") ? {type: "ws"} : ws), "where_statement"], "postprocess":  d => {
            return{
                "type":"update",
                "params":{
                    "where" : d[8],
    ...
    {"name": "delete_statement", "symbols": ["kw_delete", (lexer.has("ws") ? {type: "ws"} : ws), "kw_from", (lexer.has("ws") ? {type: "ws"} : ws), "collection_name", (lexer.has("ws") ? {type: "ws"} : ws), "where_statement"], "postprocess":  d => {
            return{
                "type":"delete",
                "params":{
                    "where" : d[6],
    ...
    {"name": "statement", "symbols": ["create_collection_statement"], "postprocess": d => d[0]},
